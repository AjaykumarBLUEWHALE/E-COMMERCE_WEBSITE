...
<div className="sm:flex  gap-2 ">  
  ...
  <div data-tooltip="Buy Now" className="button4 font-bold" >
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github aj-icon-shere" viewBox="0 0 16 16">
<path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.533 5.47 7.59.4.074.55-.174.55-.388 0-.19-.007-.693-.01-1.36-2.226.483-2.695-1.073-2.695-1.073-.364-.925-.89-1.172-.89-1.172-.727-.497.055-.487.055-.487 .803.056 1.225.824 1.225.824.714 1.223 1.872.87 2.329.665.072-.517.279-.87.508-1.07-1.777-.202-3.644-.888-3.644-3.953 0-.873.312-1.587.823-2.147-.083-.202-.357-1.017.078-2.122 0 0 .672-.215 2.2.82A7.657 7.657 0 0 1 8 4.69c.68.003 1.367.092 2.007.27 1.527-1.035 2.198-.82 2.198-.82.437 1.105.163 1.92.08 2.122.513.56.822 1.274.822 2.147 0 3.073-1.87 3.748-3.653 3.947.287.246.543.735.543 1.48 0 1.07-.01 1.933-.01 2.195 0 .216.146.466.552.387C13.71 14.53 16 11.54 16 8c0-4.42-3.58-8-8-8z"/>
</svg>
   <a href="https://www.instagram.com/zackzyrical/"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram aj-icon-shere" viewBox="0 0 16 16">
  ...
  <a href="https://wa.me/8750212460">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp aj-icon-shere" viewBox="0 0 16 16">
